...
const texts = [
  ...
  {
    text: 'aaaaaaaaaaaaasdadasdasdasdasdasdasd',
    width: windowWidth,
    fontSize: 16,
    lineHeight: 25,
  },
  {
    text:
      'aaaaaaaaaaaamaDSBasdfgkgasKDGaksjdkasGDKgasdkgsDKJgksdgkjSGDKJHagsdkgSDHJ\n\n\nsdfsdfsfsdfasdasdasadasdasdasdasdasd',
    width: windowWidth,
    fontSize: 16,
    lineHeight: 25,
  },
  {
    text:
      'Pennsylvania, bang có thể đưa Biden vượt mốc 270 phiếu đại cử tri để giành thắng lợi cuộc bầu cử Mỹ, có thể hoàn thành kiểm phiếu trong ngày 6/11, các quan chức bang cho hay. Biden hiện chỉ cách Trump chưa đầy 18.000 phiếu ở bang này. Trump từng dẫn trước tới nửa triệu phiếu vài giờ sau khi các điểm bỏ phiếu đóng cửa.',
    width: windowWidth,
    fontSize: 16,
    lineHeight: 25,
  },
...
export default function App() {
  ...
  React.useEffect(() => {
    ...
    TboxCommons.addToHome({
      url: 'tikivn://apps/com.tini.appstore',
      appName: 'App Store',
      appId: 'vn.tiki.appstore',
      icon:
  ...
  return (
    <View style={styles.container}>
      <ScrollView style={{ marginTop: 50, flex: 1 }}>
        {result &&
          result.map((size: any, index: number) => {
            /* console.log(index); */
            return (
              <Text
                style={{
